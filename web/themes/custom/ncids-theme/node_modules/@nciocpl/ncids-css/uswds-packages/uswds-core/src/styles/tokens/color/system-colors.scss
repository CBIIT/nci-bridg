...
@use "gray" as *;
@use "gray-warm" as *;
@use "black-transparent" as *;
@use "white-transparent" as *;
@use "global" as *;

@use "../../functions/general" as general;

$system-colors: general.map-collect(
  $system-color-cerulean,
  $system-color-cranberry,
  $system-color-golden,
  $system-color-navy,
  $system-color-teal,
